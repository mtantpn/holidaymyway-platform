  ...
  return (
    <div className="mt-10 pt-8 border-t border-gray-100">
      ...
      <div className="flex flex-wrap gap-2">
        <button
          onClick={() =>
            share(`https://twitter.com/intent/tweet?text=${encodedTitle}&url=${encoded}`)
          }
          className="inline-flex items-center gap-2 rounded-full border border-gray-200 px-4 py-2 text-sm font-medium text-gray-700 hover:border-gray-400 hover:bg-gray-50 transition-colors"
        ...
        <button
          onClick={() =>
            share(`https://wa.me/?text=${encodedTitle}+${encoded}`)
          }
          className="inline-flex items-center gap-2 rounded-full border border-gray-200 px-4 py-2 text-sm font-medium text-gray-700 hover:border-gray-400 hover:bg-gray-50 transition-colors"
        ...
        <button
          ...
          className={`inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-medium transition-colors ${
            copied
              ? 'border-holiday-teal bg-holiday-teal/10 text-holiday-teal'
